...
print('___________________1_______________________________________________________')
...
print('___________________2_______________________________________________________')

print(soup_emp)


print('____________________3______________________________________________________')
...
print('__________________________________________________________________________')
print('_____________________________create_____________________________________________')
